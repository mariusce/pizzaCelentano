...
export default class CheckoutA extends Component {
  ...
  componentDidMount() {
    ...
    this.totalAmount = navigation.getParam('product');
  }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              ...
              >
                <View style={styles.form}>
                  <Subtitle2 style={styles.overline}>Adresă livrare</Subtitle2>
                  <UnderlineTextInput
                    onRef={r => {
                      this.address = r;
                    }}
              ...
              <KeyboardAwareScrollView>
                <View style={styles.form}>
                  ...
                  <View style={styles.row}>
                    ...
                    <Subtitle1 style={styles.amount}>{`lei ${this.totalAmount}`}</Subtitle1>
                  </View>
                </View>
              </KeyboardAwareScrollView>
            </Swiper>
            ...
            <View style={styles.buttonContainer}>
              {activeIndex < 1 && (
                <Button onPress={this.nextStep} title="Continuă" rounded />
              )}
          ...
          <InfoModal
            ...
            title={"Succes!".toUpperCase()}
            message="Comanda a fost trimisă cu succes."
            buttonTitle="Înapoi la meniu"
